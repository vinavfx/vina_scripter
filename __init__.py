...
def setup():
    path = os.path.join(get_nuke_path(), 'vina_scripter')
    source = 'vina_scripter' if os.path.isdir(path) else 'vina.scripter'

    panels.init( source + '.vina_scripter.scripter_panel.panel_scripter', 'Vina Scripter')
